...
-----
    ...
    python mfa_privileged_check.py --accounts data/privileged_accounts.csv \
                                   --mfa data/mfa_enrollment.csv \
                                   --outdir output
...
def main():
    ...
    parser.add_argument("--accounts", default="data/privileged_accounts.csv",
                        help="CSV with the list of privileged accounts")
    parser.add_argument("--mfa", default="data/mfa_enrollment.csv",
